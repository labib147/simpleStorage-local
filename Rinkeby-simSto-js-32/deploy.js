...
async function main() {
    ...
    const wallet = new ethers.Wallet(process.env.PRIVATE_KEY, provider); // we still have to connect the provider
    ...
    // );
    // // We're not connecting our wallet with a provider here when we make our transaction with our contract factory
